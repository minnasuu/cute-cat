...
export const huajiaoSkills: Skill[] = [
  { id: 'generate-todo', name: '代办清单', icon: '📋', description: '分析需求，自动生成结构化待办清单', input: 'json', output: 'json', provider: 'Gemini', mockResult: '输出 JSON 代办清单 (8项待办)' },
  ...
  { id: 'recruit-cat', name: '招募新猫', icon: '🐱', description: '根据团队需求招募新猫并定义角色', input: 'json', output: 'json', provider: 'Gemini', mockResult: '新猫已招募' },
];
