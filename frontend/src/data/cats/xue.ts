...
export const xueSkills: Skill[] = [
  ...
  { id: 'trend-analysis', name: '趋势分析', icon: '📈', description: '对时序数据进行趋势分析和异常检测', input: 'json', output: 'json', provider: 'Gemini', mockResult: '返回 JSON 趋势结论 + 异常点' },
  { id: 'site-analyze', name: '网站诊断', icon: '🔬', description: '分析网站内容分布和质量，给出优化建议', input: 'url', output: 'json', provider: 'Gemini', mockResult: '输出 JSON 诊断报告 (6条建议)' },
];
