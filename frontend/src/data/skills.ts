...
export const skillPool: SkillTemplate[] = [
  ...
  { id: 'send-email',        name: '发送邮件',   icon: '📧', category: 'comm', description: '发送 HTML 格式邮件',                     input: 'text', output: 'email', primitiveId: 'email-send',        provider: 'SMTP',
    paramDefs: [
      { key: 'to', label: '收件邮箱', type: 'text', placeholder: 'user@example.com', required: true, description: '不填则使用系统默认邮箱' },
  ...
  { id: 'create-article',     name: '新增文章',   icon: '✍️', category: 'data',   description: '发布新文章（接收 JSON 对象）',              input: 'json', output: 'json', primitiveId: 'api-call',          provider: 'REST API', adminOnly: true,
    paramDefs: [
  ...
  { id: 'create-craft',       name: '新增 Craft', icon: '🛠️', category: 'data',  description: '批量创建 Craft（接收 JSON 数组）',          input: 'json', output: 'json', primitiveId: 'api-call',          provider: 'REST API', adminOnly: true,
    paramDefs: [
      { key: 'jsonData', label: 'Craft JSON 数组', type: 'textarea', required: true, placeholder: '[{"name":"名称","description":"描述","category":"effect","technologies":["React"],"htmlCode":"<div>HTML</div>","configSchema":[]}]' },
    ],
  },
]
