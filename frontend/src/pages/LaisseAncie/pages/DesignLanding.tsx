  ...
  return (
    <div className="p-8 lg:p-12 max-w-6xl mx-auto">
      <header className="mb-10">
        <h1 className="text-5xl font-semibold text-blue-600 tracking-tight">Create</h1>
        ...
        {(["illustration", "single", "collection", "occasion"] as DesignMode[]).map((m) => (
          <button key={m} onClick={() => void navigate(`/laisse-ancie/design/${m}`)} className="text-left">
            <Card interactive className="h-full flex flex-col gap-3 min-h-[220px]">
              <div className="text-4xl text-blue-600 leading-none">{ICONS[m]}</div>
              <div>
              ...
              <div className="text-[13px] font-medium text-blue-600 mt-1">{CTAS[m]} →</div>
            </Card>
          </button>
        ))}
      </section>
